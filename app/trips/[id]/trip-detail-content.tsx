...
export default function TripDetailContent({ trip, itineraryItems }: TripDetailContentProps) {
  const { subtrips } = useTripContext();
      ...
      <div className="flex-1 container mx-auto px-4 max-w-7xl pb-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
          ...
          <div className="modern-card p-6 min-h-[600px]">
            <MapView destination={trip.destination} subtrips={subtrips} />
          </div>
        </div>
      </div>
    </>
